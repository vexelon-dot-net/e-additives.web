...
define({
    ...
    // Home page
    "home": {
        "jumbotron" : "Целта на проекта E-additives е да предостави web платформа, която да позволява на потребителите да се информират относно добавките в храните.",
    ...
    "goodies": {
        ...
        "developers": {
            ...
            "docu_body1": 'Най-новата документация, базирана на последната production версия, можете да намерите на \
