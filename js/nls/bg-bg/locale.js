...
define({
    ...
    // Home page
    "home": {
        "jumbotron" : "Знаете ли какво ядете? Не! Е, ...и ние. :)) Затова създадхоме платформата E-additives. <br> \
        Искаме да превърнем E-additives в място, където можете да намерите, коментирате и коригирате информацията \
